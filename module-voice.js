...
/* "OdeBot" : en français, le T final est muet (comme dans "robot" → "robo"),
   donc le moteur TTS prononçait "Odebo". On respelle phonétiquement
   "Odebotte" (comme "carotte"/"botte") pour forcer le T à être prononcé —
   uniquement pour la voix, la transcription écrite garde "OdeBot". */
.replace(/\bOdeBot\b/gi, 'Odebotte')
.trim();
}
