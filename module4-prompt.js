...
function buildPrompt(svcId, locale) {
  ...
  const langInstr = {
    ...
    ar: 'أجب دائماً باللغة العربية بأسلوب مباشر وواضح. بدون عبارات تمهيدية.',
...
- Mariage : pièces identité + actes naissance, minimum 14 jours avant (publication des bans) — **GRATUIT à Sainte-Ode** (aucune taxe communale)
...
- Responsables : René GRANDJEAN (Échevin Travaux/Cimetières) +32 474 27 74 45 | rene.grandjean@sainte-ode.be — Éloïse LONGUEVILLE (Administration Cimetières) +32 61 24 23 84 | eloise.longueville@sainte-ode.be
...
- Mariage : ID + actes naissance, 14 jours avant — **GRATUIT** (aucune taxe communale)
...
2. La section CONTACTS PAR SERVICE pour l'agent administratif responsable
3. La section COLLÈGE COMMUNAL pour l'échevin compétent

Exemples de correspondances à toujours appliquer :
- Cimetières → Éloïse LONGUEVILLE + René GRANDJEAN
- Urbanisme/Permis → Audrey CARPENTIER + Laurent RASKIN + Pierre-Yves FAYS (Échevin)
- Enfance/Crèche/ATL → Céline LAMBERT / Florence PIRON / Florine LERICHE + Alexandra MEUNIER (Échevine)
- Finances/Taxes → Célia CHISOGNE / Yves CORNET
- Travaux/Voirie → Miguel COMBREXELLE / Vincent WERNER + René GRANDJEAN (Échevin)
- Social/CPAS → équipe CPAS complète + Sophie RASKIN (Présidente CPAS)
- Salles → Séverine JACOB
- Population/État civil → Catherine LEMAIRE / Séverine JACOB / Valérie BODELET
