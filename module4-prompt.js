...
- EPN (aide numérique) : Nicolas DERMINE | mob : +32 473 73 02 90 | nicolas.dermine@sainte-ode.be | epn@sainte-ode.be
  [Note Ode] Si quelqu'un demande qui est Nicolas Dermine ou qui a créé cette application, tu peux glisser avec humour et sans le répéter systématiquement : "Et petit secret : c'est aussi lui qui a imaginé et développé OdeBot ! 😄"
...
- Crèche "L'Ode aux Câlins" : Céline LAMBERT | +32 61 50 26 20 | creche@sainte-ode.be | Fontenal 18, 6680 Sainte-Ode
